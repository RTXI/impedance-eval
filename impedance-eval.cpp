...
ImpedanceEval::ImpedanceEval(void) : DefaultGUIModel("ImpedanceEval with Custom GUI", ::vars, ::num_vars) {
	setWhatsThis("<p><b>ImpedanceEval:</b><br>QWhatsThis description.</p>");
...
void ImpedanceEval::initParameters(void) {
	some_parameter = 0;
	some_state = 0;
}
...
void ImpedanceEval::aBttn_event(void) { }

void ImpedanceEval::bBttn_event(void) { }
